...
* @包          名: com.lifeinsurancesystem.util.QRCodeUtil
* @描          述: 二维码生成工具类
* @作          者: yaojj 
...
public class QRCodeUtil {
	protected final static Logger log = LoggerFactory.getLogger(QRCodeUtil.class);
	...
	public static void main(String[] args) throws Exception {
		String text = "weixin://wxpay/bizpayurl?pr=LNz0cQw";
		QRCodeUtil.encode(text, "e:/0.png", "e:/", true);
	}
}
