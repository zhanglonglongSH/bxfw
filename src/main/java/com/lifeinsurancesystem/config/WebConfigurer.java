...
public class WebConfigurer implements ServletContextInitializer,EmbeddedServletContainerCustomizer {
	...
	/**
	 * Initializes initUploadFile Servlet.
	 */
	private void initUploadFile(ServletContext servletContext,EnumSet<DispatcherType> disps) {
		log.debug("Registering Aliyun Servlet Start...");
//		ServletRegistration.Dynamic uploadServlet=servletContext.addServlet("UploadFileToAliyun","com.simu800.framework.servlet.UploadFileToAliyun");
//		uploadServlet.setInitParameter("accessKeyId", aliyunOssConfig.getAccessKeyId());
//		uploadServlet.setInitParameter("accessKeySecret", aliyunOssConfig.getAccessKeySecret());
//		uploadServlet.setInitParameter("endPoint", aliyunOssConfig.getEndPoint());
//		uploadServlet.setInitParameter("imgPoint", aliyunOssConfig.getImgPoint());
//		uploadServlet.setInitParameter("alibuckets", aliyunOssConfig.getAlibuckets());
//
//		uploadServlet.setInitParameter("ocsEnable", aliyunOcsConfig.getOcsEnable());
//		uploadServlet.setInitParameter("ocsHost", aliyunOcsConfig.getOcsHost());
//		uploadServlet.setInitParameter("ocsPort", aliyunOcsConfig.getOcsPort());
//		uploadServlet.setInitParameter("ocsUserName", aliyunOcsConfig.getOcsUserName());
//		uploadServlet.setInitParameter("ocsPassword", aliyunOcsConfig.getOcsPassword());
//		
//		uploadServlet.setLoadOnStartup(1);
//		uploadServlet.addMapping("/uploadFile");
		log.debug("Registering Aliyun Servlet End...");
	}
}
