 ...
 */
public class KPIReportFormDaoImpl implements IKPIReportFormDao {
	protected final Logger log = LoggerFactory.getLogger(KPIReportFormDaoImpl.class);
	@Autowired
    private SqlSessionTemplate sqlSessionTemplate;
	public KPIReportFormDaoImpl() {
